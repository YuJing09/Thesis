...
from modell2 import EfficientNet,Ypgru,Ypdanet,Ypdanet2,Ypreg
...
def h5_to_pb(h5_save_path,pb_save_name,block_args,global_params):
    if "json" not in h5_save_path:
       try:
                   # you shold load your model here
          model=Ypreg(2)
          ...
          model.load_weights('/media/jinnliu/My Passport/yp-Efficient-0221/weights-reg-improvement-30-2.02.hdf5') model1.h5
          model.summary()
