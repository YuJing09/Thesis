...
from modell_transform import Ypgru2,Ypgru
...
if __name__=="__main__":
  ...
  filepath="./saved_model/tom/weights-gru-improvement-{epoch:02d}-{val_loss:.2f}.hdf5"
  checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1)
  callbacks_list = [checkpoint]
  adam=optimizers.Adam(lr=0.0001)
  model.load_weights('./saved_model/weights-gru-improvement-30-2.15.hdf5',by_name=True)
  ...
  np.save('./loss_history/loss_gru3',np.array(history.history['loss']))
  np.save('./loss_history/val_loss_gru3',np.array(history.history['val_loss']))
