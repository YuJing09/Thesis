...
if __name__=="__main__":
  ...
  filepath="./saved_model/weights-ypgrudanet-improvement-{epoch:02d}-{val_loss:.2f}.hdf5"
  checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1)
  callbacks_list = [checkpoint]
  adam=optimizers.Adam(lr=0.0001)
  #model.load_weights('./saved_model/weights-v-improvement-12-1.26.hdf5',by_name=True)
  ...
  np.save('./loss_history/loss_grudanet',np.array(history.history['loss']))
  np.save('./loss_history/val_loss_grudanet',np.array(history.history['val_loss']))
