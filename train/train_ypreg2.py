...
if __name__=="__main__":
  ...
  model.load_weights('./saved_model/weights-reg-improvement-30-2.02.hdf5',by_name=True)
  ...
  np.save('./loss_history/loss_reg6',np.array(history.history['loss']))
  np.save('./loss_history/val_loss_reg6',np.array(history.history['val_loss']))
