...
def custom_loss(y_true, y_pred,delta=2.):
 ...
 # error_lead2=tf.abs(tf.subtract(true_lead[:],pred_lead[:]))
  ...
  loss=points_all_loss+lead_all_loss+valid_len_loss+bce
...
if __name__=="__main__":
  ...
  parser.add_argument('--val_port', type=int, default=5554, help='Port of server for validation dataset.')
  ...
  model.load_weights('./saved_model/weights-improvement-05-1.00.hdf5')
